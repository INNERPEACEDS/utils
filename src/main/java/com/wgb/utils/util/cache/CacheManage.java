...
public class CacheManage {
	...
	/**
	 * 代付安全验证码缓存 存在时间 5分钟
	 * cache Key Constant.DF_SECURITY_EMAILCODE+email 当前登录用户的email 即发送邮件的目标邮箱
	 * @author yanlong
	 * @date 2017-6-23
	 */
	public static Cache<String,SmsCodeModel> dfSecurityEmailCodeCache = new Cache<String,SmsCodeModel>(5);
